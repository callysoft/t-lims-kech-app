...
import { OtherCategoryComponent } from './items/other-category/other-category.component';
import { UserpaymentComponent } from './user/userpayment/userpayment.component';
import { ViewAdminTransactionComponent } from './admin/view-admin-transaction/view-admin-transaction.component';
...
@NgModule({
  ...
  declarations: [UsersComponent, CategoryComponent, PendingAdsComponent, FavoritesComponent, AdsComponent,
    ...
    RealEstateComponent, PetComponent, DeclinedAdsComponent, ListItemsComponent, ListItemFormComponent, ListItemViewComponent, OtherCategoryComponent, UserpaymentComponent, ViewAdminTransactionComponent],
  providers: [
