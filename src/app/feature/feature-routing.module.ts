    ...
    path: '', children: [
      { path: 'dashboard', component: DashboardComponent },
      {
        path: 'user', children: [
          ...
          { path: 'products/:id', component: UserpaymentComponent },
      ...
      },
      {
        path: 'admin', component: AdminHomeComponent, children: [
          ...
          { path: 'products/getall', component: ViewAdminTransactionComponent },
          {path: 'products/:id', component: UpdateTransactionsComponent},
